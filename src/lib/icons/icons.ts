export const icons = {
  ...
  sparkle: {
    symbol:
      '<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.334" d="M7.348 1.877a.667.667 0 0 1 1.312 0l.7 3.707a1.33 1.33 0 0 0 1.064 1.063l3.707.701a.667.667 0 0 1 0 1.312l-3.707.7a1.33 1.33 0 0 0-1.063 1.064L8.66 14.13a.667.667 0 0 1-1.312 0l-.7-3.707A1.33 1.33 0 0 0 5.583 9.36L1.877 8.66a.667.667 0 0 1 0-1.312l3.707-.7a1.33 1.33 0 0 0 1.063-1.064z"/>',
    viewBox: '0 0 16 16',
    set: 'lucide'
  },
  terminal: {
  ...
  design: {
    symbol:
      '<g transform="scale(0.667)"><path d="M20 19.88V22l-1.8-1.17-4.79-9a4.9 4.9 0 0 0 1.78-1M15 7a3 3 0 0 1-3 3 3 3 0 0 1-.44 0L5.8 20.83 4 22v-2.12L9.79 9A3 3 0 0 1 12 4V2a1 1 0 0 1 1 1v1.18A3 3 0 0 1 15 7m-2 0a1 1 0 1 0-1 1 1 1 0 0 0 1-1m-8.78 3L6 11.8l-1.44 2.76L2.1 12.1m9.9 5.66-1.5-1.51L9 19l3 3 3-3-1.47-2.77M19.78 10 18 11.8l1.5 2.76 2.4-2.46Z" fill="currentColor"/></g>',
    viewBox: '0 0 16 16',
    set: 'svg'
  },
  plan: {
